...
const ru = {
  ...
  "smart.company.foundersTitle": "Учредители",
  "smart.company.foundersSubtitle": "Укажите участников сделки",
  "smart.company.foundersCountLabel": "Количество учредителей",
  "smart.company.founderOrdinal": "{{n}}-й учредитель",
  "smart.company.founderNameLabel": "ИМЯ ИЛИ НИК",
