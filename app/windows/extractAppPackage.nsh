...
!macro extractUsing7za FILE
  ...
  !insertmacro HspInstallDetailPrint "[installer] Installing application files (package extracted; copying to destination)"
  ...
  LoopExtract7za:
    ...
    DetailPrint "Error: could not update installed files (details in install log)."
    ${if} $R1 < 15
