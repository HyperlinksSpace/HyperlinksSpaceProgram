# Fork of app-builder-lib templates/nsis/include/installer.nsh (electron-builder 26.x).
# Only change: !include "hsp-extractAppPackage.nsh" instead of extractAppPackage.nsh so our
# extract macros always load from buildResources and never collide with bundled app-builder paths.
# When upgrading electron-builder, diff upstream installer.nsh and merge.

!include "hsp-extractAppPackage.nsh"
