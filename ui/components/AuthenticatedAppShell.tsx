...
/**
 * Narrow `/swap`, `/smarts`, `/trade`, `/send`, `/get` chrome: centered logo header (same as `/key` / TMA logo-only strip) and padded body.
 * Wide send/get/trade/smarts/swap render in the home split column on `/`, not this shell.
 */
